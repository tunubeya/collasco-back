...
import { CreateTicketShareLinkDto } from './dto/create-ticket-share-link.dto';
...
export class TicketShareLinksController {
  ...
  create(
    ...
    @Body() dto: CreateTicketShareLinkDto,
    @CurrentUser() user: AccessTokenPayload,
  ) {
    return this.shareLinksService.create(projectId, dto.name, user);
  }
